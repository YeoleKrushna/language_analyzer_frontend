...
async function loadHistory() {
    const token = checkAuth();
    const historyList = document.getElementById("history-list"); // correct ID
    try {
...
// app.js (or inside your main JS file)
document.addEventListener("DOMContentLoaded", () => {
    ...
    historyBtn.addEventListener("click", async (e) => {
        ...
        // Load history only if dropdown is visible
...
// Function to load recent chats into sidebar dropdown
async function loadHistoryDropdown() {
    ...
    try {
        ...
        const data = await response.json(); // assuming array of history items
...
// Function to display chat in main area (optional)
